...
- **Meru Pro:** Turn on Lite mode for an account to show a simple inbox instead of Gmail, cutting the memory that account uses by a large amount. Unread mail, the badge and notifications keep coming from the mail feed, and Gmail is one click away
