...
import { useConfigMutation } from "@/lib/react-query";

const columnHelper = createColumnHelper<InboxMessage>();
...
export function InboxTable({
  ...
  const runAction = useCallback(async (message: InboxMessage, action: GmailAction) => {
