  ...
  switch (app) {
    ...
    case "notebook": {
      return (
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
          <path
            d="M1.9162 15.6978c0 -0.3074 0 -0.1507 -0.003 -0.401m11.1137 0.3403l0.001 0.0607m-11.1105 0l-0.0042 -0.5507m15.6116 0l-0.0008 0.5507m-15.6054 0.0002l-0.0053 -0.7044c0 -5.5559 4.5041 -10.06 10.06 -10.06 5.5559 0 10.06 4.5041 10.06 10.06v0.7044"
            stroke="#3186FF"
            strokeWidth={2.6}
            strokeMiterlimit={10}
          />
          <path
            d="M1.9162 15.6996c0 -0.3074 0 -0.1507 -0.003 -0.401m0.0041 0.401l-0.0042 -0.5508c0 -4.3443 3.5885 -7.7454 7.8661 -7.7454s7.7455 3.4678 7.7455 7.7454l-0.0008 0.5508m-15.6054 0.0001l-0.0053 -0.7043"
            stroke="#4FA0FF"
            strokeWidth={2.6}
            strokeMiterlimit={10}
          />
          <path
            d="M18.8232 19.2541c0 0.4142 -0.3358 0.75 -0.75 0.75h-1.1c-0.4142 0 -0.75 -0.3358 -0.75 -0.75v-3.5539l2.6 0v3.5539z"
            fill="#4FA0FF"
          />
          <path
            d="M23.332 19.2541c0 0.4142 -0.3358 0.75 -0.75 0.75h-1.1c-0.4142 0 -0.75 -0.3358 -0.75 -0.75v-3.5539l2.6 0v3.5539z"
            fill="#3186FF"
          />
          <path
            d="M7.3032 8.6111c3.8331 0 6.9492 3.0691 7.0253 6.884h0.0006v0.0271c0.0005 0.033 0.0009 0.0661 0.001 0.0992l0.0009 0.0562h-0.0019v3.5713c0 0.4142 -0.3358 0.75 -0.75 0.75h-1.1c-0.4142 0 -0.75 -0.3358 -0.75 -0.75v-3.7061c-0.0507 -2.4009 -2.0128 -4.3318 -4.4259 -4.3318 -1.2703 0 -2.2864 0.4419 -2.9768 1.1288 -0.6555 0.6522 -1.0829 1.5902 -1.1091 2.764l0.0045 0.585h-0.0023l0 0.0053h0.0002v3.5539c0 0.4142 -0.3358 0.75 -0.75 0.75H1.3698c-0.4142 0 -0.75 -0.3358 -0.75 -0.75v-3.5494h-0.0002c0 -0.089 -0.0001 -0.1365 -0.0002 -0.1645l-0.0005 -0.0682 -0.0004 -0.0213c-0.0005 -0.0277 -0.0011 -0.0669 -0.0019 -0.1312 -0.0008 -0.0735 -0.0006 -0.1466 0.0006 -0.2193l-0.0007 -0.0898 0.0027 0c0.0497 -1.7791 0.7161 -3.3559 1.8733 -4.5074 1.2218 -1.2157 2.9181 -1.8859 4.8107 -1.8859z"
          ...
          <defs>
            <radialGradient
              ...
              cy={0}
              r={1}
              gradientTransform="matrix(-8.3 0.4998 -0.7073 -11.7383 12.0031 16.7)"
              gradientUnits="userSpaceOnUse"
            >
